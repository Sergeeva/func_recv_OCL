...
\input{func_recv_notation}

\input{func_recv_alg}

\input{OCL_model}

\input{func_recv_scheme_OCL}
...
В статье предложен параллельный вычислительный алгоритм восстановления данных
в модели Open CL и описана его программная реализация для гетерогенных
систем, включающих в себя
